...
public class ModFluidTagsProvider extends FluidTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        this.tag(KDWFluidTags.JUICE_FRUIT)
                ...
                .addOptional(ResourceLocation.fromNamespaceAndPath("kaleidoscope_dim_wine", "lunar_berries_juice"))
                .addOptional(ResourceLocation.fromNamespaceAndPath("kaleidoscope_dim_wine", "abyssal_fruit_juice"))
                .addOptional(ResourceLocation.fromNamespaceAndPath("kaleidoscope_dim_wine", "silver_pungency_fruit_juice"));
        ...
        this.tag(KDWFluidTags.JUICE_FRUIT_ENCHANTED_BERRY)
                .addOptional(ResourceLocation.fromNamespaceAndPath("kaleidoscope_dim_wine", "enchanted_berry_juice"));
        this.tag(KDWFluidTags.JUICE_FRUIT_LUNAR_BERRIES)
                .addOptional(ResourceLocation.fromNamespaceAndPath("kaleidoscope_dim_wine", "lunar_berries_juice"));
        this.tag(KDWFluidTags.JUICE_FRUIT_ABYSSAL_FRUIT)
                .addOptional(ResourceLocation.fromNamespaceAndPath("kaleidoscope_dim_wine", "abyssal_fruit_juice"));
        this.tag(KDWFluidTags.JUICE_FRUIT_SILVER_PUNGENCY_FRUIT)
                .addOptional(ResourceLocation.fromNamespaceAndPath("kaleidoscope_dim_wine", "silver_pungency_fruit_juice"));
    }
}
