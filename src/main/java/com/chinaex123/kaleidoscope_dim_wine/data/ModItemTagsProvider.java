...
public class ModItemTagsProvider  extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        this.tag(ModItemTags.VINERY_SMALL_BOTTLE)
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.CRIMSON_CRESCENDO.get())) // 绯红绝响
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.ETHEREAL_NOBLE.get())) // 诡影尊爵
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.WART_HENNESSY.get())) // 疣域轩尼诗
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.BLAZE_MARTELL.get())) // 烈焰马爹利
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.BLACK_BONE_LAFITE.get())) // 黑骨拉菲
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.CHORUS_COGNAC.get())) // 紫颂干邑
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.DRAGONS_BREATH_BRANDY.get())) // 龙息白兰地
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.ABYSSAL_PORTER.get())) // 深渊波特
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.SILENT_SHERRY.get())) // 静默雪莉
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.FORGOTTEN_MARGARITA.get())) // 遗忘玛格丽特
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.PHANTOM_DREAM_BUBBLE.get())) // 幻梦泡影
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.END_STARLIGHT.get())) // 终末星光
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.DIVINE_EMBRYO_PORT.get())) // 神血波尔多
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.DRACONIC_BLOOD_WINE.get())); // 龙血酒
        // vinery:large_bottle
        this.tag(ModItemTags.VINERY_LARGE_BOTTLE)
                .addOptional(BuiltInRegistries.ITEM.getKey(ModItems.MAGMA_ROYAL_SALUTE.get())); // 岩浆皇家礼炮
