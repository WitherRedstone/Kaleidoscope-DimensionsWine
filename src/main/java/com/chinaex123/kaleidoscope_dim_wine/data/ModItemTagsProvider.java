...
public class ModItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        tag(TagMod.COCKTAIL_INGREDIENT_BLACK)
                .addOptional(ResourceLocation.fromNamespaceAndPath(KaleidoscopeDimensionsWine.MOD_ID, "star_trail"))
                .addOptional(ResourceLocation.fromNamespaceAndPath(KaleidoscopeDimensionsWine.MOD_ID, "lunar_eclipse"))
                .addOptional(ResourceLocation.fromNamespaceAndPath(KaleidoscopeDimensionsWine.MOD_ID, "eclipse"));
        // 深蓝色
        tag(TagMod.COCKTAIL_INGREDIENT_DARK_BLUE)
                ...
                .addOptional(ResourceLocation.fromNamespaceAndPath(KaleidoscopeDimensionsWine.MOD_ID, "deep_freeze"));
        // 深绿色
        ...
        tag(TagMod.COCKTAIL_INGREDIENT_DARK_RED)
                ...
                .addOptional(ResourceLocation.fromNamespaceAndPath(KaleidoscopeDimensionsWine.MOD_ID, "giants_hymn"))
                .addOptional(ResourceLocation.fromNamespaceAndPath(KaleidoscopeDimensionsWine.MOD_ID, "blood_moon"))
                .addOptional(ResourceLocation.fromNamespaceAndPath(KaleidoscopeDimensionsWine.MOD_ID, "abyss"))
                .addOptional(ResourceLocation.fromNamespaceAndPath(KaleidoscopeDimensionsWine.MOD_ID, "rangers_satchel"))
                .addOptional(ResourceLocation.fromNamespaceAndPath(KaleidoscopeDimensionsWine.MOD_ID, "blazing_sun"));
        // 深紫色
        tag(TagMod.COCKTAIL_INGREDIENT_DARK_PURPLE)
                ...
                .addOptional(ResourceLocation.fromNamespaceAndPath(KaleidoscopeDimensionsWine.MOD_ID, "aurora"));
        // 金色
        tag(TagMod.COCKTAIL_INGREDIENT_GOLD)
                ...
                .addOptional(ResourceLocation.fromNamespaceAndPath(KaleidoscopeDimensionsWine.MOD_ID, "divinity"));
        // 灰色
        ...
        tag(TagMod.COCKTAIL_INGREDIENT_WHITE)
                ...
                .addOptional(ResourceLocation.fromNamespaceAndPath(KaleidoscopeDimensionsWine.MOD_ID, "wind_trace"));
