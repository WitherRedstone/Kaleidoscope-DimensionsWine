...
public class KDWConfig {
    public static final ModConfigSpec.BooleanValue DRAGON_BLOOD_SPAWN_ENABLED;
    ...
    static {
        ...
        REDCAP_LOOTING_BONUS_MIN = builder
                ...
                .defineInRange("redcapLootingBonusMin", 1, 0, Integer.MAX_VALUE);
        REDCAP_LOOTING_BONUS_MAX = builder
                ...
                .defineInRange("redcapLootingBonusMax", 1, 0, Integer.MAX_VALUE);
        builder.pop();
        ...
        CRIMSON_NYLIUM_FUNGAL_SAP_COUNT = builder
                ...
                .defineInRange("crimsonNyliumFungalSapCount", 1, 0, Integer.MAX_VALUE);
        ...
        WARPED_NYLIUM_FUNGAL_SAP_COUNT = builder
                ...
                .defineInRange("warpedNyliumFungalSapCount", 1, 0, Integer.MAX_VALUE);
        ...
        ANVIL_TUFF_TO_CARBOCRETIN_MIN_OUTPUT = builder
                ...
                .defineInRange("anvilTuffToCarbocretinMinOutput", 1, 0, Integer.MAX_VALUE);
        ANVIL_TUFF_TO_CARBOCRETIN_MAX_OUTPUT = builder
                ...
                .defineInRange("anvilTuffToCarbocretinMaxOutput", 3, 0, Integer.MAX_VALUE);
        builder.pop();
