package com.chinaex123.kaleidoscope_dim_wine.client.tooltip;
...
public class KDWTooltop {
    ...
    public static void onItemTooltip(ItemTooltipEvent event) {
        ...
        // ==================== 次元维度 - 小彩蛋 ====================
        // 玩偶 - ChinaEX123_BILI
        if (stack.getItem() == KDWBlocks.DOLL_001.get().asItem()) {
        ...
        // 玩偶 - Fvue233
        if (stack.getItem() == KDWBlocks.DOLL_002.get().asItem()) {
            // 形参：原始文本, 渐变方向（true=从左到右，false=从右到左）, 动画速度, 是否加粗, 是否斜体, 是否下划线, 是否删除线, 是否乱码
        ...
        // 玩偶 - Agens_Eland
        if (stack.getItem() == KDWBlocks.DOLL_003.get().asItem()) {
            // 形参：原始文本, 渐变方向（true=从左到右，false=从右到左）, 动画速度, 是否加粗, 是否斜体, 是否下划线, 是否删除线, 是否乱码
        ...
        // ==================== 次元维度 - 下界 ====================
        // 绯红葡萄藤 - 相当于作物的种子
        if (stack.getItem() == KDWItems.CRIMSON_GRAPEVINE.get()) {
            // 形参：原始文本, 渐变方向（true=从左到右，false=从右到左）, 动画速度, 是否加粗, 是否斜体, 是否下划线, 是否删除线, 是否乱码
        ...
        // 绯红葡萄藤 - 相当于作物的种子
        if (stack.getItem() == KDWItems.WARPED_GRAPEVINE.get()) {
            // 形参：原始文本, 渐变方向（true=从左到右，false=从右到左）, 动画速度, 是否加粗, 是否斜体, 是否下划线, 是否删除线, 是否乱码
        ...
        // ==================== 次元维度 - 末地 ====================
        // 迷梦果
        if (stack.getItem() == KDWItems.DREAMFRUIT.get()) {
            // 形参：原始文本, 渐变方向（true=从左到右，false=从右到左）, 动画速度, 是否加粗, 是否斜体, 是否下划线, 是否删除线, 是否乱码
