...
public class CrimsonGrapevineTrellisBlock extends GrapevineTrellisBlock {
    ...
    public CrimsonGrapevineTrellisBlock() {
        super(
                ...
                () -> ModBlocks.CRIMSON_GRAPE_CROP.get().defaultBlockState()
        );
    }
    ...
    public ItemInteractionResult useItemOn(ItemStack stack, BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hitResult) {
        ...
        if (itemInHand.canPerformAction(ItemAbilities.SHEARS_HARVEST)) {
            ...
            Block.popResource(level, pos, ModItems.CRIMSON_GRAPEVINE.get().getDefaultInstance());
    ...
    public boolean sameType(BlockState state) {
        ...
        return state.is(com.github.ysbbbbbb.kaleidoscopetavern.init.ModBlocks.TRELLIS.get()) ||
                state.is(ModBlocks.CRIMSON_GRAPEVINE_TRELLIS.get());
    }
    ...
    public void doGrow(Level level, BlockPos pos, BlockState state) {
        ...
        if (isMaxAge(state)) {
            ...
            if (canGrowGrape(level, pos)) {
                // 生成绯红葡萄果实
                level.setBlockAndUpdate(pos.below(), ModBlocks.CRIMSON_GRAPE_CROP.get().defaultBlockState());
