...
public class KDWItems {
    ...
    public static final RegistryObject<Item> MOD_LOGO = ITEMS_REGISTER.register("mod_logo", () -> new Item(new Item.Properties()));
    // 天使之翼
    public static final RegistryObject<Item> ANGEL_WINGS = ITEMS_REGISTER.register("angel_wings", () -> new Item(new Item.Properties().rarity(Rarity.EPIC)));
    // 天使之羽
    public static final RegistryObject<Item> ANGEL_FEATHER = ITEMS_REGISTER.register("angel_feather", () -> new Item(new Item.Properties().rarity(Rarity.RARE)));

    // -------------------- 瓶装 --------------------
    // 易拉罐
    public static final RegistryObject<Item> POP_CAN = ITEMS_REGISTER.register("pop_can", () ->
            new BottleBlockItem(KDWBlocks.POP_CAN.get(), new Item.Properties()));

    // ==================== 次元维度 - 下界 ====================
    // -------------------- 作物 --------------------
    // 绯红葡萄藤 - 相当于作物的种子
    public static final RegistryObject<Item> CRIMSON_GRAPEVINE = ITEMS_REGISTER.register("crimson_grapevine", CrimsonGrapevineItem::new);
     // 绯红葡萄 - 结出的果实
    public static final RegistryObject<Item> CRIMSON_GRAPE = ITEMS_REGISTER.register("crimson_grape", () ->
             new Item(new Item.Properties().food(KDWFoods.CRIMSON_GRAPE)));
    // 诡异葡萄藤 - 相当于作物的种子
    public static final RegistryObject<Item> WARPED_GRAPEVINE = ITEMS_REGISTER.register("warped_grapevine", WarpedGrapevineItem::new);
    // 诡异葡萄 - 结出的果实
    public static final RegistryObject<Item> WARPED_GRAPE = ITEMS_REGISTER.register("warped_grape", () ->
            new Item(new Item.Properties().food(KDWFoods.WARPED_GRAPE)));
    // -------------------- 物品 --------------------
    // 绯红菌露
    public static final RegistryObject<Item> CRIMSON_FUNGAL_SAP = ITEMS_REGISTER.register("crimson_fungal_sap", () -> new Item(new Item.Properties()));
    // 诡影菌髓
    public static final RegistryObject<Item> WARPED_FUNGAL_SAP = ITEMS_REGISTER.register("warped_fungal_sap", () -> new Item(new Item.Properties()));
    // -------------------- 流体 --------------------
    // 绯红葡萄汁桶
    public static final RegistryObject<Item> CRIMSON_GRAPE_JUICE_BUCKET = ITEMS_REGISTER.register("crimson_grape_juice_bucket", () ->
            new JuiceBucketItem(KDWFluids.CRIMSON_GRAPE_JUICE));
    // 诡异葡萄汁桶
    public static final RegistryObject<Item> WARPED_GRAPE_JUICE_BUCKET = ITEMS_REGISTER.register("warped_grape_juice_bucket", () ->
            new JuiceBucketItem(KDWFluids.WARPED_GRAPE_JUICE));
    // -------------------- 酒类 --------------------
    // 绯红绝响
    ...
    // -------------------- 作物 --------------------
    // 迷梦果
    public static final RegistryObject<Item> DREAMFRUIT = ITEMS_REGISTER.register("dreamfruit", () ->
            new DreamfruitCropWildVineItem(new Item.Properties().food(KDWFoods.DREAMFRUIT)));
    // -------------------- 物品 --------------------
    // 龙血瓶
    public static final RegistryObject<Item> DRAGON_BLOOD_BOTTLE = ITEMS_REGISTER.register("dragon_blood_bottle", () ->
    ...
    public static final RegistryObject<Item> DREAMFRUIT_JUICE_BUCKET = ITEMS_REGISTER.register("dreamfruit_juice_bucket", () ->
            new JuiceBucketItem(KDWFluids.DREAMFRUIT_JUICE));
    // 龙血桶
