...
public class KDWFluids {
    ...
    public static void register(RegisterEvent event) {
        event.register(FLUID_TYPES, helper -> {
            // 绯红葡萄汁
            helper.register(CRIMSON_GRAPE_JUICE_ID, new KDWFluidTypes(CRIMSON_GRAPE_JUICE_ID, 0, 0, true, false));
            // 诡异葡萄汁
            helper.register(WARPED_GRAPE_JUICE_ID, new KDWFluidTypes(WARPED_GRAPE_JUICE_ID, 0, 0, true, false));
            // 迷梦果汁
            helper.register(DREAMFRUIT_JUICE_ID, new KDWFluidTypes(DREAMFRUIT_JUICE_ID, 0, 3, true, false));
            // 龙血
            helper.register(DRAGON_BLOOD_ID, new KDWFluidTypes(DRAGON_BLOOD_ID, 0, 6, false, false));
        });
