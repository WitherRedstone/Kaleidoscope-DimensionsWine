...
public interface KDWBlocks {
    ...
    DeferredBlock<Block> STRING_LIGHTS_BLOCK_BEDROCK = registerStringLights("string_lights_block_bedrock", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER = registerStringLights("string_lights_entity_shulker", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_WHITE = registerStringLights("string_lights_entity_shulker_white", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_ORANGE = registerStringLights("string_lights_entity_shulker_orange", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_MAGENTA = registerStringLights("string_lights_entity_shulker_magenta", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_LIGHT_BLUE = registerStringLights("string_lights_entity_shulker_light_blue", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_YELLOW = registerStringLights("string_lights_entity_shulker_yellow", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_LIME = registerStringLights("string_lights_entity_shulker_lime", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_PINK = registerStringLights("string_lights_entity_shulker_pink", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_GRAY = registerStringLights("string_lights_entity_shulker_gray", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_LIGHT_GRAY = registerStringLights("string_lights_entity_shulker_light_gray", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_CYAN = registerStringLights("string_lights_entity_shulker_cyan", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_PURPLE = registerStringLights("string_lights_entity_shulker_purple", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_BLUE = registerStringLights("string_lights_entity_shulker_blue", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_BROWN = registerStringLights("string_lights_entity_shulker_brown", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_GREEN = registerStringLights("string_lights_entity_shulker_green", () -> new StringLightsBlock(null));
    DeferredBlock<Block> STRING_LIGHTS_ENTITY_SHULKER_RED = registerStringLights("string_lights_entity_shulker_red", () -> new StringLightsBlock(null));
    ...
    // ==================== 次元维度 - 下界 ====================
    // 作物
    DeferredBlock<Block> CRIMSON_GRAPE_CROP = BLOCK_REGISTER.register("crimson_grape_crop", CrimsonGrapeCropBlock::new);
    DeferredBlock<Block> CRIMSON_GRAPEVINE_TRELLIS = BLOCK_REGISTER.register("crimson_grapevine_trellis", CrimsonGrapevineTrellisBlock::new);
    DeferredBlock<Block> CRIMSON_GRAPEVINE = BLOCK_REGISTER.register("crimson_grapevine", CrimsonGrapeCropWildGrapevineHead::new);
    DeferredBlock<Block> CRIMSON_GRAPEVINE_PLANT = BLOCK_REGISTER.register("crimson_grapevine_plant", CrimsonGrapeCropWildGrapevinePlant::new);
    DeferredBlock<Block> WARPED_GRAPE_CROP = BLOCK_REGISTER.register("warped_grape_crop", WarpedGrapeCropBlock::new);
    DeferredBlock<Block> WARPED_GRAPEVINE_TRELLIS = BLOCK_REGISTER.register("warped_grapevine_trellis", WarpedGrapevineTrellisBlock::new);
    DeferredBlock<Block> WARPED_GRAPEVINE = BLOCK_REGISTER.register("warped_grapevine", WarpedGrapeCropWildGrapevineHead::new);
    ...
    // ==================== 次元维度 - 末地 ====================
    // 流体
    DeferredBlock<LiquidBlock> DRAGON_BLOOD_FLUID =
    ...
    // 作物
    DeferredBlock<Block> DREAMFRUIT_VINE = BLOCK_REGISTER.register("dreamfruit_vine", DreamfruitCropWildVineHead::new);
    ...
    DeferredHolder<Block, Block> DRACONIC_BLOOD_WINE = BLOCK_REGISTER.register("draconic_blood_wine", () -> DrinkBlock.create().maxCount(4).shapes(DrinkShapes.getStandardBottleShapes()).build().get());
    ...
    static <T extends Block> DeferredBlock<T> registerBlocks(String name, Supplier<T> block, Rarity rarity) {
