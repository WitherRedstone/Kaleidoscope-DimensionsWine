            ...
            CREATIVE_MODE_TAB.register("kaleidoscope_dim_wine_tab", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        if (ModList.get().isLoaded("eternal_starlight")) {
                            // -------------------- 物品 --------------------
                            output.accept(EternalStarlightItems.LUNAR_BERRIES_JUICE_BUCKET.get()); // 月辉浆果汁桶
                            output.accept(EternalStarlightItems.ABYSSAL_FRUIT_JUICE_BUCKET.get()); // 渊海果汁桶
                            output.accept(EternalStarlightItems.SILVER_PUNGENCY_FRUIT_JUICE_BUCKET.get()); // 银辛果汁桶
                            // -------------------- 酒类 --------------------
                            output.accept(BottleBlockItem.getMaxLevelDrink(EternalStarlightItems.DIVINITY)); // 神圣裁决
                            output.accept(BottleBlockItem.getMaxLevelDrink(EternalStarlightItems.STAR_TRAIL)); // 星轨
                            output.accept(BottleBlockItem.getMaxLevelDrink(EternalStarlightItems.AURORA)); // 极光
                            output.accept(BottleBlockItem.getMaxLevelDrink(EternalStarlightItems.ECLIPSE)); // 日蚀
                            output.accept(BottleBlockItem.getMaxLevelDrink(EternalStarlightItems.LUNAR_ECLIPSE)); // 月蚀
                            output.accept(BottleBlockItem.getMaxLevelDrink(EternalStarlightItems.DEEP_FREEZE)); // 深寒
                            output.accept(BottleBlockItem.getMaxLevelDrink(EternalStarlightItems.BLOOD_MOON)); // 血月
                            output.accept(BottleBlockItem.getMaxLevelDrink(EternalStarlightItems.ABYSS)); // 深渊
                            output.accept(BottleBlockItem.getMaxLevelDrink(EternalStarlightItems.BLAZING_SUN)); // 烈阳
                            output.accept(BottleBlockItem.getMaxLevelDrink(EternalStarlightItems.WIND_TRACE)); // 风痕
