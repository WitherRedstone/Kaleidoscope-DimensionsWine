...
public class KDWCompostables {
    public static void setup(FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            ComposterBlock.COMPOSTABLES.put(KDWItems.WARPED_GRAPE.get(), 0.65F); // 诡异葡萄 - 结出的果实
            ComposterBlock.COMPOSTABLES.put(KDWItems.CRIMSON_FUNGAL_SAP.get(), 0.25F); // 绯红菌露
            ComposterBlock.COMPOSTABLES.put(KDWItems.WARPED_FUNGAL_SAP.get(), 0.25F); // 诡影菌髓
            // ==================== 次元维度 - 末地 ====================
            ComposterBlock.COMPOSTABLES.put(KDWItems.DREAMFRUIT.get(), 0.65F); // 迷梦果
