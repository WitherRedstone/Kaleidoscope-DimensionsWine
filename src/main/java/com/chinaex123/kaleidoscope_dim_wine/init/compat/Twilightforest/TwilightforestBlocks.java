...
public interface TwilightforestBlocks {
    ...
    RegistryObject<Block> GIANTS_HYMN = BLOCK_REGISTER.register("giants_hymn", () -> DrinkBlock.create().maxCount(2).shapes(DrinkShapes.getStandardBottleShapes()).build().get());
