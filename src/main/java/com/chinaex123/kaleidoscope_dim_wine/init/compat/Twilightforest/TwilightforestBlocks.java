...
public interface TwilightforestBlocks {
    ...
    DeferredHolder<Block, Block> DAWNLIGHT_DEW = BLOCK_REGISTER.register("dawnlight_dew", () -> DrinkBlock.create().maxCount(2).irregular().shapes(DrinkShapes.getStandardBottleShapes()).build().get());
    DeferredHolder<Block, Block> DEAD_END_SPITTLE = BLOCK_REGISTER.register("dead_end_spittle", () -> DrinkBlock.create().maxCount(2).irregular().shapes(DrinkShapes.getStandardBottleShapes()).build().get());
    ...
    DeferredHolder<Block, Block> FROSTVEIN_BEASTBLOOD = BLOCK_REGISTER.register("frostvein_beastblood", () -> DrinkBlock.create().maxCount(2).irregular().shapes(DrinkShapes.getStandardBottleShapes()).build().get());
    ...
    DeferredHolder<Block, Block> GIANTS_HYMN = BLOCK_REGISTER.register("giants_hymn", () -> DrinkBlock.create().maxCount(2).irregular().shapes(DrinkShapes.getStandardBottleShapes()).build().get());
