...
public interface TheBumblezoneItems {
    ...
    RegistryObject<Item> PEPSI = ITEMS_REGISTER.register("pepsi", () -> new PopCanDrinkItem(TheBumblezoneBlocks.PEPSI.get()));
    RegistryObject<Item> FANTA = ITEMS_REGISTER.register("fanta", () -> new PopCanDrinkItem(TheBumblezoneBlocks.FANTA.get()));
