...
public class TheBumblezoneItems {
    ...
    // -------------------- 酒类 --------------------
    // 雪碧
    public static final DeferredItem<Item> SPRITE = ITEMS_REGISTER.register("sprite", () ->
            new DrinkBlockItem(TheBumblezoneBlocks.SPRITE.get()));
    // 可乐
    public static final DeferredItem<Item> PEPSI = ITEMS_REGISTER.register("pepsi", () ->
            new DrinkBlockItem(TheBumblezoneBlocks.PEPSI.get()));
    // 芬达
    public static final DeferredItem<Item> FANTA = ITEMS_REGISTER.register("fanta", () ->
            new DrinkBlockItem(TheBumblezoneBlocks.FANTA.get()));
    // 花粉甜酿
    public static final DeferredItem<Item> POLLEN_NECTAR = ITEMS_REGISTER.register("pollen_nectar", () ->
            new DrinkBlockItem(TheBumblezoneBlocks.POLLEN_NECTAR.get()));
    // 蜜刺佳酿
    public static final DeferredItem<Item> HONEYTHORN_MEAD = ITEMS_REGISTER.register("honeythorn_mead", () ->
            new DrinkBlockItem(TheBumblezoneBlocks.HONEYTHORN_MEAD.get()));
    // 蜂蜡陈酿
    public static final DeferredItem<Item> BEESWAX_HONEY_WINE = ITEMS_REGISTER.register("beeswax_honey_wine", () ->
            new DrinkBlockItem(TheBumblezoneBlocks.BEESWAX_HONEY_WINE.get()));
    // 甜蜜水晶
    public static final DeferredItem<Item> SWEET_CRYSTAL_HONEY = ITEMS_REGISTER.register("sweet_crystal_honey", () ->
            new DrinkBlockItem(TheBumblezoneBlocks.SWEET_CRYSTAL_HONEY.get()));
    // 蜂王特酿
    public static final DeferredItem<Item> ROYAL_HONEY_BREW = ITEMS_REGISTER.register("royal_honey_brew", () ->
